...
configure_ip() {
        ...
        '/initrd-network.sh' 'fa:16:3e:ee:e7:eb' '46.8.232.16/24' '46.8.232.1' '' '' 'false'
        MAC_ADDRESS=1
        return
...
echo ""
        # trans
        # echo "wget --no-check-certificate -O- https://raw.githubusercontent.com/rezamarzban/reinstall/main/trans.sh | /bin/ash" >$sysroot/etc/local.d/trans.start
        # wget --no-check-certificate -O $sysroot/etc/local.d/trans.start https://raw.githubusercontent.com/rezamarzban/reinstall/main/trans.sh
